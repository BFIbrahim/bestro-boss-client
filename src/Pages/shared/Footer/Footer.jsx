    ...
    return (
        <div>
            <footer className="md:flex text-neutral-content text-center">
                <div className='bg-[#1F2937] p-10 md:w-1/2'>
                    <div className=''>
                        ...
                        <p>Big Future Food LTD.<br />Providing reliable tech since 1992</p>
                    </div>
                </div>
                <div className='bg-[#111827] md:w-1/2'>
                    <div className='p-10'>
                        <span className="footer-title">Social</span>
                        <p className='mb-4'>Contact us In socila Media</p>
                        <div className="flex gap-4 w-24 mx-auto">
            ...
            <div className='text-center bg-gray-950 text-white py-1'>
                <p>Copyright © {year} - All right reserved by Big Future Food Ltd</p>
            </div>
        </div>
    );
};
